...
from utils.dataloader_waterline import PSPnetDataset, pspnet_dataset_collate
...
if __name__ == "__main__":
    ...
    parser.add_argument("--save_dir", type=str, default='/root/autodl-tmp/PSPNet_wawterline')
    parser.add_argument('--wandb_path', type=str, default='/root/autodl-tmp/PSPNet_wawterline/wandb', help='path of saving wandb files locally')
    ...
    #------------------------------------------------------------------#
    save_dir            = '/root/autodl-tmp/PSPNet_wawterline'
