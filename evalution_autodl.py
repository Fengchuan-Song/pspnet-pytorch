...
if __name__ == "__main__":
    ...
    parser.add_argument("--save_dir", type=str, default='/root/autodl-tmp/PSPNet_waterline')
    parser.add_argument('--wandb_path', type=str, default='/root/autodl-tmp/PSPNet_waterline/wandb', help='path of saving wandb files locally')
    parser.add_argument('--wandb_name', type=str, default='PSPNet_waterline',
    ...
    #----------------------------------------------------------------------------------------------------------------------------#
    # model_path      = "/data/PSPNet/PSPNet/weights/best_epoch_weights_ep034_mIoU0.767.pth"
    model_path      = "/root/autodl-tmp/best_epoch_weights_ep062_mIoU0.544.pth"
    #---------------------------------------------------------#
    ...
    if local_rank == 0:
        eval_callback   = EvalCallback(net=model, input_shape=input_shape, num_classes=num_classes, image_ids=val_lines, dataset_path=VOCdevkit_path,
                                        ...
                                        class_names=["background", "waterline"],
